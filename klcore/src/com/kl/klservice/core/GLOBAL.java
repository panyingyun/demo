...
public class GLOBAL {
	// 正式上线地址
	private static String DB_NAME_PUBLIC = "pushksdk_public.db"; // DB's name
	private static String pushURL_PUBLIC = "http://push.toucht.net:10000/";
	private static String pushDTS_PUBLIC = "http://push.toucht.net:10000/";
	private static String pushLOGNAME_PUBLIC = "pushksdk_public.log";
	...
	// 测试地址
	private static String DB_NAME_TEST = "pushksdk_test.db"; // DB's name
	private static String pushURL_TEST = "http://push.toucht.net:10001/";
	private static String pushDTS_TEST = "http://push.toucht.net:10000/";
	private static String pushLOGNAME_TEST = "pushksdk_test.log";
