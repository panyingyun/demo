...
import com.cl.clservice.CLReceiver;
import com.cl.clservice.ICL;
import com.cl.clservice.core.bean.ClientInfo;
import com.cl.clservice.core.bean.DBMsg;
import com.cl.clservice.core.bean.GetMsgListResp;
import com.cl.clservice.core.bean.PUSHENABLE;
import com.cl.clservice.core.bean.PushEvent;
import com.cl.clservice.core.bean.PushMsg;
import com.cl.clservice.core.bean.PushUpgrade;
import com.cl.clservice.core.database.DBHelper;
import com.cl.clservice.core.download.AutoDownload;
import com.cl.clservice.core.download.DexJarDownload;
import com.cl.clservice.core.download.DownloadCompleteReceiver;
import com.cl.clservice.core.download.DownloadManagerPro;
import com.cl.clservice.core.download.OnDownloadSuccess;
import com.cl.clservice.core.download.PicDownload;
import com.cl.clservice.core.httpconnect.HttpConnect;
import com.cl.clservice.core.notification.NotifyMgr;

public class CLMgr implements ICL {
	public static final String TAG = "CLMgr";
	...
	public CLMgr(Context ctx) {
		this.ctx = ctx;
		SLog.e(TAG, "create CLMgr successful!!!");
	}
	...
	// register CL receiver
	CLReceiver clReceiver = null;

	private void registerNetworkReceiver() {
		clReceiver = new CLReceiver();
		IntentFilter filter = new IntentFilter();
		filter.addAction(CLReceiver.ACTION_NET);
		filter.addAction(CLReceiver.ACTION_UNLOCK);
		ctx.registerReceiver(clReceiver, filter);
	}

	private void unregisterNetworkReceiver() {
		if (clReceiver != null) {
			ctx.unregisterReceiver(clReceiver);
			clReceiver = null;
		}
	}
